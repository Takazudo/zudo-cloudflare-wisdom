...
// src/components/theme-toggle.tsx. Type references via the global React
// namespace still resolve via @types/react.
import { useState, useEffect } from "preact/hooks";
import clsx from "clsx";
// Pull lifecycle event names from the zudo-doc transitions module rather
// than hard-coding `astro:*`/`DOMContentLoaded` literals — zfb's router
// fires `zfb:after-swap` (AFTER_NAVIGATE_EVENT) after each navigation.
...
// leaving an empty mobile drawer. The host header (_header-with-defaults.tsx)
// passes nodes/currentSlug/rootMenuItems/... as data props, so this
// component must accept and forward them. zudolab/zudo-doc#1355 wave 13.5.
