...
:::note[This page covers the Pages branch-deploy model]
Standalone Workers don't have a `--branch` flag -- see [Workers PR Previews](./workers-pr-previews.mdx) for the version-alias recipe instead.
:::
