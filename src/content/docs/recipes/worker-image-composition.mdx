...
- [Wrangler Configuration](../workers/wrangler-config.mdx#bindings-images) -- declaring the `[images]` binding, and the fact that named environments do not inherit it.
