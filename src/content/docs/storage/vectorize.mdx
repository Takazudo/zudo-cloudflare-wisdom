...
- **No local emulation**: `wrangler dev` doesn't emulate Vectorize at all -- see the [binding support matrix](../workers/local-dev-bindings.mdx) for what does and doesn't work locally
