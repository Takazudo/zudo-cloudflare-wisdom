...
- **Proxy workers** -- Routing or transforming requests; see [Reverse Proxy to a Fixed Upstream](../recipes/reverse-proxy.mdx) for header hygiene, manual redirect rewriting, and caching safety
