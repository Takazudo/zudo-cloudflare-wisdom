...
| Images (`[images]` binding) | Partial -- `width`, `height`, `rotate`, and `format` only; `fit` / `gravity` and real decoding need a deployment | No |
