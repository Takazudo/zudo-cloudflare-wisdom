...
# See issue #30 for the full scaffold flags. Features not scaffolded
# (e.g. tauri, designTokenPanel, imageEnlarge, versioning) are intentionally
# absent; their template files would produce spurious [MISSING IN PROD] errors
# if checked.
#
...
for feature in i18n llmsTxt docHistory bodyFootUtil claudeResources sidebarResizer sidebarToggle docTags tagGovernance; do
